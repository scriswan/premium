...
Exp1=$(curl https://raw.githubusercontent.com/scriswan/premium/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/scriswan/premium/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/scriswan/premium/main/REGIST | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/scriswan/premium/main/REGIST | grep $ipsaya | awk '{print $3}')
...
wget https://raw.githubusercontent.com/scriswan/premium/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
cd
